...
namespace Mapsui48.Host.Embedding
{
    public static class WindowEmbedder
    {
        ...
        public static void AttachTo(Window window, IntPtr parentHwnd)
        {
            var helper = new WindowInteropHelper(window);
            IntPtr hostHwnd = helper.EnsureHandle();
        ...
        public static void UpdateSize(Window window, IntPtr parentHwnd)
        {
            var helper = new WindowInteropHelper(window);
            IntPtr hostHwnd = helper.Handle;
