...
namespace Mapsui48.Client
{
    ...
    public class MapCustomTooltipForm : Form
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            // Dark Tactical Glass Background
            using (var brush = new SolidBrush(Color.FromArgb(240, 15, 22, 30)))
            {
            ...
            if (!string.IsNullOrEmpty(_description))
            {
                ...
                using (var descBrush = new SolidBrush(Color.FromArgb(200, 203, 213, 225))) // Slate-300
                {
